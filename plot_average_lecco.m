function plot_average_lecco(delta_t, cur_iter, tot_exposed, tot_infected, tot_recovered, tot_dead, tot_quarantined, ... 
    tot_isolated, tot_severe_inf, tot_cases, actual_cases, actual_death, actual_date, std_dev_dead, std_dev_tot)
