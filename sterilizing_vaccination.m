...
rand_vac = 0; % 0: no vaccination; 1: rand vaccination
vacc_all = 0; % 0: age based vaccinaton, 1: vaccinate all
if rand_vac == 1 && vacc_all == 0
    maps_path = sprintf('sterilizing_age/vac_rate_%d/maps', num_daily_vacc);
elseif rand_vac == 1 && vacc_all == 1
    maps_path = sprintf('sterilizing_all/vac_rate_%d/maps', num_daily_vacc);
else
...
save 'output/lecco_steril_vacc_4.mat'
