...
if rand_vac == 1 && vacc_all == 0
    maps_path = sprintf('effective_age_69/vac_rate_%d/maps', num_daily_vacc);
elseif rand_vac == 1 && vacc_all == 1
    maps_path = sprintf('effective_all_69/vac_rate_%d/maps', num_daily_vacc);
else
...
save 'output/lecco_effective_vacc_age_69_8.mat'
