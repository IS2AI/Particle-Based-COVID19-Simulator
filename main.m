...
for num_sim = 1:num_simulations
    ...
    for ind = 1:num_iter
        ...
        if mod(ind, vis) == 0
            close all;
            plot_current_states(delta_t, ind, tot_exposed, tot_infected, tot_recovered, tot_dead, ...
                tot_true_quarantined, tot_true_isolated, tot_severe_inf, tot_cases, save_figures)
